...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function check(){
		if(document.form1.username.value=="")
			alert("请输入姓名");
		else if(document.form1.userpasswd.value=="")
			alert("请输入密码");
	...
	<div id="main">
		<form method="post" name="form1" action="LoginServlet">
			<table>
				...
				<tr>
					<td></td>
					<td><span><img id="vCode" style="width: 70px;height: 34px;border: 1px solid #000;" src="<c:url value='/VerifyCodeServlet'/>" /><a
					href="javascript: _change()" style="font-size:13px;"> 看不清，换一张</a></span></td>
					
				</tr>
			</table>
						
			<input type="submit" value="提交"  class="bottom" onclick="check()">
